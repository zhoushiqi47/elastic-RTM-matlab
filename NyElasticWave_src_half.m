...
for kk=1:Nomegas
    ...
    rGG  = Elastic_GreenTensor_Thalf_SIP(omega,kp,ks,yl,xl);
    ...
    Gs1 = Elastic_GreenTensor_Thalf_SIP3(omega,kp,ks,xsource,xobs);
    Gs = - transpose(Gs1); 
   ...
   %% 计算样本点的散射数据
    ...
    if n_src==n_recv
        ...
        Gr = Elastic_GreenTensor_Thalf_SIP2(omega,kp,ks,xobs2,xreceiver);
    end
