function G=TractionGreenTensor_2D(omega,kp,ks,z0,z)
%% n=(0,1)
%% operator T to z
...
G(1,:) = mu*(gs112-gs222) - 2*mu*gp112;
G(2,:) = 2*mu*gs122 - cp2*gp122 - lamda*gp111;
G(3,:) = mu*(gs122-gs111) - 2*mu*gp122;
G(4,:) = -2*mu*gs112 - cp2*gp222 - lamda*gp112;
